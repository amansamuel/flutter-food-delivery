          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(order.food.name ,style: TextStyle(fontSize: 18.0,
                  ...
                  Text(order.restaurant.name,style: TextStyle(fontSize: 16.0,fontWeight: FontWeight.w600,),
                    overflow: TextOverflow.ellipsis,),
                  SizedBox(height:4.0),
                  Text(order.date,style: TextStyle(fontSize: 16.0,fontWeight: FontWeight.w600,),
                    overflow: TextOverflow.ellipsis,),
                  SizedBox(height:4.0),
                ],
              ),
